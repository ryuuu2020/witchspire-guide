...
export const metadata = {
  title: "Consumables & Potions Guide — Coming Soon | Witchspire",
  description: "Consumables & Potions Guide is coming soon. We are working on a comprehensive guide for Witchspire.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-center">
      <div className="bg-parchment-light rounded-xl p-10 border border-border-subtle">
        ...
        <h1 className="font-display text-3xl text-ink mb-3">Consumables & Potions Guide</h1>
